...
class _State extends State<JoinChannelAudio> {
   RtcEngine _engine;
  String channelId = Constants.CHANNEL_NAME;
  bool isJoined = false,
      openMicrophone = true,
  ...
  _initEngine() async {
    _engine = await RtcEngine.createWithConfig(RtcEngineConfig(Constants.APP_ID));
    this._addListeners();
  ...
  _addListeners() {
    _engine.setEventHandler(RtcEngineEventHandler(
      ...
      leaveChannel: (stats) async {
        ...
        await _engine
            .joinChannel(Constants.APP_TOKEN, Constants.CHANNEL_NAME, null, generateRandomString(5))
            .catchError((err) {
  ...
  _joinChannel() async {
    ...
    await _engine
        .joinChannel(Constants.APP_TOKEN, Constants.CHANNEL_NAME, null,
